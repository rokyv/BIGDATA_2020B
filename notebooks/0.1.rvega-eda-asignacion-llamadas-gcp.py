...
def list_file():
    ...
    bucket_name="rvega_bucket_llamadas123"
...
def replace_columns(new_data):
    ...
    if 'RECEPCION' in new_data.columns:
        ...
        logging.warning(f'Se creo columna RECEPCION vacia, funcion : {replace_columns.__name__}')
...
def load_file(file):
    ...
    """
    bucket = "gs://rvega_bucket_llamadas123"
    ...
    if check == True:
        ...
        logging.warning(f'remplazando columnas, archivo : {file}')
...
def save_bq(new_data):
    ...
    try:
        ...
        job = client.load_table_from_dataframe(
            new_data, "espbigdata2022.espbigdata2022.llamadas_123"
        )  # Make an API request.
